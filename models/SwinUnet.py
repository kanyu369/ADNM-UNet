...
_C.MODEL.PRETRAIN_CKPT = 'models/swin_tiny_patch4_window7_224_lite.yaml'
_C.MODEL.RESUME = ''
...
parser.add_argument('--cfg', type=str, default='models/swin_tiny_patch4_window7_224_lite.yaml', metavar="FILE", help='path to config file', )
parser.add_argument(
    "--opts",
...
# def create_swin_unet(config_path='swin_tiny_patch4_window7_224_lite.yaml'):
#     # 生成参数对象
#     parser = argparse.ArgumentParser()
...
parser.add_argument('--cfg', type=str, default='models/swin_tiny_patch4_window7_224_lite.yaml', metavar="FILE")
...
# 覆盖关键参数
args.cfg = 'models/swin_tiny_patch4_window7_224_lite.yaml'  # 直接指定配置文件路径
...
if __name__ == '__main__':
    ...
    # 示例输入
    x = torch.randn(4, config.MODEL.SWIN.IN_CHANS, config.DATA.IMG_SIZE, config.DATA.IMG_SIZE)
    output = model(x)
