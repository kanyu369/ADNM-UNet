...
datasets = ['Shanghai','LAPS',]
model_names=['ADNMUnet','SmaATUnet','MambaUNet','TrajGRU','ConvLSTM','LPTQPN','TransUnet','SwinUnet']
...
for dataset in datasets:
    for model_name in model_names:
        for j in range(5):
            ...
            if model_name == 'ADNMUnet' or 'ADNMUnet_without_ADNSSD' or 'ADNMUnet_without_MFEM' or 'ADNMUnet_without_WDFM':
                warmup_epoch=4
                epochs = 40
            ...
            for epoch in range(1,epochs+1):
                ...
                with torch.no_grad():
                    for batch in val_dataloader:
                        imgs, targets = batch[:,:input_frames,:,:,:],data[:,input_frames:,:,:,:]
                ...
                if (if_save_epoch is False and val_loss<best) or (if_save_epoch is True and epoch>save_epoch and val_loss<best):
                    ...
                    file_name = f"{model_name}_best_{j}.pth"
